...
import com.example.jobapplication.databinding.ActivityPostedJobsBinding;
import com.example.jobapplication.databinding.ActivityRemoveJobBinding;
...
public class RemoveJob extends AppCompatActivity {
    ActivityRemoveJobBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityRemoveJobBinding.inflate(getLayoutInflater());
        ...
        onJobClicked = position -> startActivity(new Intent(RemoveJob.this, RemoveJobDetails.class)
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                recyclerView.setAdapter(new JobsAdapter(jobs, RemoveJob.this, onJobClicked));
    ...
    private void searchJob(ArrayList<JobModel> arrayList, String query) {
        ...
        if (query.isEmpty()) {
            ...
            for (JobModel jobModel : arrayList) {
                ...
                recyclerView.setAdapter(new JobsAdapter(filteredList, RemoveJob.this, onJobClicked));
            }
        }
    }
}