...
public class AvailableJobsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        onJobClicked = position -> startActivity(new Intent(AvailableJobsActivity.this, ApplyJobActivity.class)
    ...
    private void searchJob(ArrayList<JobModel> arrayList, String query) {
        ...
        if (query.isEmpty()) {
            ...
            for (JobModel jobModel : arrayList) {
                ...
                recyclerView.setAdapter(new JobsAdapter(filteredList, AvailableJobsActivity.this, onJobClicked));
            }
        }
    }
}
