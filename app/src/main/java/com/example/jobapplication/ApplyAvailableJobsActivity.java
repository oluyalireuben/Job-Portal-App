...
import com.example.jobapplication.databinding.ActivityApplyAvailableJobsBinding;
...
public class ApplyAvailableJobsActivity extends AppCompatActivity {
    ActivityApplyAvailableJobsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityApplyAvailableJobsBinding.inflate(getLayoutInflater());
        ...
        onJobClicked = position -> startActivity(new Intent(ApplyAvailableJobsActivity.this, ApplyJobActivity.class)
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                recyclerView.setAdapter(new JobsAdapter(jobs, ApplyAvailableJobsActivity.this, onJobClicked));
    ...
    private void searchJob(ArrayList<JobModel> arrayList, String query) {
        ...
        if (query.isEmpty()) {
            ...
            for (JobModel jobModel : arrayList) {
                ...
                recyclerView.setAdapter(new JobsAdapter(filteredList, ApplyAvailableJobsActivity.this, onJobClicked));
            }
        }
    }
}