...
import com.example.jobapplication.databinding.ActivityAppliedJobsBinding;
...
public class AppliedJobsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        onJobClicked = position -> startActivity(new Intent(AppliedJobsActivity.this, AppliedJobDetails.class)
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                recyclerView.setAdapter(new JobsAdapter(jobs, AppliedJobsActivity.this, onJobClicked));
    ...
    private void searchJob(ArrayList<JobModel> arrayList, String query) {
        ...
        if (query.isEmpty()) {
            ...
            for (JobModel jobModel : arrayList) {
                ...
                recyclerView.setAdapter(new JobsAdapter(filteredList, AppliedJobsActivity.this, onJobClicked));
            }
        }
    }
}