...
public class PostedJobsActivity extends AppCompatActivity {
    ...
    ActivityPostedJobsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        onJobClicked = position -> startActivity(new Intent(PostedJobsActivity.this, PostedJobDetails.class)
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                recyclerView.setAdapter(new JobsAdapter(jobs, PostedJobsActivity.this, onJobClicked));
    ...
    private void searchJob(ArrayList<JobModel> arrayList, String query) {
        ...
        if (query.isEmpty()) {
            ...
            for (JobModel jobModel : arrayList) {
                ...
                recyclerView.setAdapter(new JobsAdapter(filteredList, PostedJobsActivity.this, onJobClicked));
            }
        }
    }
}